                    angular.module('gridApp', ['ngMaterial'])
                               .controller('GridListCtrl', function ($scope) {
                                           ...
                                           this.colorTiles = (function () {
                                                       ...
                                                       for (var i = 0; i < 46; i++) {
														   var periodo = i % 6
                                                                   tiles.push({
                                                                              color: colorPeriodo(periodo),
                                                                              colspan: randomSpan(coluna),
                                                                              rowspan: randomSpan(linha)
                                                                   });
                                                       }
                                                       return tiles;
                                           })();
                                           ...
                                           function colorPeriodo(periodo) {
                                                       return COLORS[periodo];
                                           }
   
                                           function randomSpan(tipo) {
